"""Plot concordance and standardized-coefficient heatmaps for unit-agreeing OI AFT fits."""
...
PLOTS = Path("open_interest_figures/native/aft_unit_agreeing_oi_plots")
