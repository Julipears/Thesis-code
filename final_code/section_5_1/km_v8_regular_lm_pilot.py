...
Lee-Mykland code is adapted from
Martin Magris (2026). Lee Mykland nonparametric jump detection (https://www.mathworks.com/matlabcentral/fileexchange/71058-lee-mykland-nonparametric-jump-detection), MATLAB Central File Exchange. Retrieved September 22, 2026.
"""
...
def regular_lee_mykland(
    ...
    annual_observations = 365.0 * 24.0 * 60.0 * 60.0 / step_seconds # we use 1s here
