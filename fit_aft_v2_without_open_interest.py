"""Fit a separate log-logistic AFT specification without open interest.

The input rows are the unit-agreeing-OI AFT files.  The model keeps the other
six covariates from the original downsized specification and writes to a separate v2
